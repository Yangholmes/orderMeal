...
class record{
	...
	public $records = [ 
		...
		"1"=>[ "recid" => "2", "name" => "李二嘴", "engName" => "Erzui", "sex" =>"0", "age" => "29", "department" => "1" ] ,
		"2"=>[ "recid" => "3", "name" => "李三嘴", "engName" => "Sanzui", "sex" =>"1", "age" => "40", "department" => "1" ] ,
		"3"=>[ "recid" => "4", "name" => "李四嘴", "engName" => "Sizui", "sex" =>"0", "age" => "19", "department" => "1" ] ,
		"4"=>[ "recid" => "5", "name" => "李五嘴", "engName" => "Wuzui", "sex" =>"1", "age" => "33", "department" => "1" ] ,
